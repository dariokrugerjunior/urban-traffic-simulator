import { CONGESTION_HEX, CONGESTION_LABEL, type CongestionLevel } from '../types/traffic';
...
export function Legend() {
  return (
    <div className="rounded-2xl border border-white/10 bg-neutral-900/80 px-4 py-3 shadow-xl shadow-black/40 backdrop-blur-md">
      <p className="mb-2 text-[11px] font-semibold uppercase tracking-widest text-neutral-500">Congestion</p>
